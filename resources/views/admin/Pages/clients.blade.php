                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        ...
                        <ul class="breadcrumb-contents-list list-style-none">
                            ...
                            <li class="breadcrumb-contents-list-item"> Users </li>
        ...
        <div class="container">
            <div class="dashboard-contents-wrapper">
                ...
                <div class="dashboard-right-contents mt-4 mt-lg-0" style="border-radius:5px">
                    <div class="breadcrumb-contents">
                        <p>{{ __('backend/Pages/users.title') }}</p>
                    </div>
                    <br><br>
                    @if (count($users) == 0)
                        <div class="alert alert-danger" role="alert">
                            {{ __('backend/Pages/users.no_users') }}
                        </div>
                    @else
                        <div class="table-responsive">
                            <table id="example" class="table table-striped" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>{{ __('backend/Pages/users.name') }}</th>
                                        <th>{{ __('backend/Pages/users.email') }}</th>
                                        <th>{{ __('backend/Pages/users.phone') }}</th>
                                        <th>{{ __('backend/Pages/users.Status') }}</th>
                                        <th>{{ __('backend/Pages/users.opt') }}</th>
                                    </tr>
                                </thead>
                                <tbody>
