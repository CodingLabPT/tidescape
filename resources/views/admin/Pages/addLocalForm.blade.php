                            ...
                            <div class="card-body">
                                <form method="POST" action="/cadastrarLocal">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button style="background-color: #0B5ED7" type="submit" class="btn btn-primary"><i class="fas fa-plus"></i>{{ __('backend/Pages/addLocalForm.submit_btn') }}</button>
                                        <a title="Go Back" class="btn btn-secondary" href="{{ URL::previous() }}"><i class="fas fa-arrow-left"></i> {{ __('backend/Pages/addLocalForm.go_back_btn') }}</a>
                                    </div>
                                </form>
                            </div>
                        </div>
