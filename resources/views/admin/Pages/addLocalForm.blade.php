                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        ...
                        <ul class="breadcrumb-contents-list list-style-none">
                            ...
                            <li class="breadcrumb-contents-list-item"> {{ __('backend/Pages/addLocalForm.title') }} </li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="dashboard-contents-wrapper">
                ...
                <div class="dashboard-right-contents mt-4 mt-lg-0" style="border-radius:5px">
                    <div class="breadcrumb-contents">
                        <p>{{ __('backend/Pages/addLocalForm.title') }}</p>
                    </div>
                            ...
                            <div class="card-body">
                                <form method="POST" action="{{ route('locals.store') }}">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <button style="background-color: #0B5ED7" type="submit" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i>{{ __('backend/Pages/addLocalForm.submit_btn') }}</button>
                                        <a title="Go Back" class="btn btn-secondary btn-sm" href="{{ URL::previous() }}"><i class="fas fa-arrow-left"></i> {{ __('backend/Pages/addLocalForm.go_back_btn') }}</a>
                                    </div>
                                </form>
                            </div>
                        </div>
