                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        ...
                        <ul class="breadcrumb-contents-list list-style-none">
                            ...
                            <li class="breadcrumb-contents-list-item"><span style="font-style: italic; color: #999999">{{ __('backend/Pages/addTourForm.AddTourTitle') }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <form method="POST" action="{{ route('tours.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="mb-4 text-center col-md-4">
                                <label for="img" class="block text-gray-700 text-sm font-bold">{{ __('backend/Pages/addTourForm.principal_img') }}</label>
                                <small for="img" class="block text-gray-500 text-sm mb-2">{{ __('backend/Pages/addTourForm.drag_and_drop') }}</small>
                            ...
                            <div class="mb-4 text-center col-md-4">
                                <label for="img2" class="block text-gray-700 text-sm font-bold">{{ __('backend/Pages/addTourForm.adicional_img') }}</label>
                                <small for="img2" class="block text-gray-500 text-sm mb-2">{{ __('backend/Pages/addTourForm.drag_and_drop') }}</small>
                                <div class="flex justify-center mb-4">
                                    <div class="relative">
                            ...
                            <div class="mb-4 text-center col-md-4">
                                <label for="img3" class="block text-gray-700 text-sm font-bold">{{ __('backend/Pages/addTourForm.adicional_img') }}</label>
                                <small for="img3" class="block text-gray-500 text-sm mb-2">{{ __('backend/Pages/addTourForm.drag_and_drop') }}</small>
                                <div class="flex justify-center mb-4">
                                    <div class="relative">
                        ...
                        <div class="mb-3">
                            <span style="font-style: italic; color: #999999">{{ __('backend/Pages/addTourForm.name') }}</span>
                            <input placeholder="{{ __('backend/Pages/addTourForm.namePlaceholder') }}" type="text" class="form-control" id="name" name="name" required>
                        </div>

                        <div class="mb-3">
                            <span style="font-style: italic; color: #999999">{{ __('backend/Pages/addTourForm.local') }}</span>
                        ...
                        <div class="mb-3">
                            <span style="font-style: italic; color: #999999">{{ __('backend/Pages/addTourForm.duration') }}</span>
                        ...
                        <fieldset class="border p-4 mb-4">
                            <legend class="w-auto">{{ __('backend/Pages/addTourForm.prices') }}</legend>
                            <div class="row">
                                <div class="col-md-4 mb-3">
                                    <label for="ep" class="form-label">{{ __('backend/Pages/addTourForm.pricesmall') }} (€)</label>
                                    <input class="form-control" type="number" id="ep" name="ep" placeholder="{{ __('backend/Pages/addTourForm.prices_desc') }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="eg" class="form-label">{{ __('backend/Pages/addTourForm.pricebig') }} (€)</label>
                                    <input class="form-control" type="number" id="eg" name="eg" placeholder="{{ __('backend/Pages/addTourForm.prices_desc') }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="emg" class="form-label">{{ __('backend/Pages/addTourForm.priceslarge') }} (€)</label>
                                    <input class="form-control" type="number" id="emg" name="emg" placeholder="{{ __('backend/Pages/addTourForm.prices_desc') }}" required>
                                </div>
                            </div>
                        </fieldset>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="destaque" id="destaque" class="form-control">
                                <option value="sim">{{ __('backend/Pages/addTourForm.highlightyes') }}</option>
                                <option value="nao">{{ __('backend/Pages/addTourForm.highlightno') }}</option>
                            </select>
                        </div>
