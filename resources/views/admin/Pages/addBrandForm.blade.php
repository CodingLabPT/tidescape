                ...
                <div class="col-lg-12">
                    <div class="breadcrumb-contents">
                        ...
                        <ul class="breadcrumb-contents-list list-style-none">
                            ...
                            <li class="breadcrumb-contents-list-item"><span style="font-style: italic; color: #999999">{{ __('backend/Pages/addBrandForm.title') }}</span></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="dashboard-contents-wrapper">
                ...
                <div class="dashboard-right-contents mt-4 mt-lg-0" style="border-radius:5px">
                    <div class="breadcrumb-contents">
                        <p>{{ __('backend/Pages/addBrandForm.title') }}</p>
                    </div>
                    <br>
                    <form method="POST" action="{{ route('brands.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row" style="display: flex; align-items: center; justify-content: center">
                            <div class="mb-4 text-center col-md-4">
                                <label for="img" class="block text-gray-700 text-sm font-bold">{{ __('backend/Pages/addBrandForm.image') }}</label>
                                <small for="img" class="block text-gray-500 text-sm mb-2">{{ __('backend/Pages/addBrandForm.drag_and_drop') }}</small>
                        ...
                        <div class="mb-3">
                            <span style="font-style: italic; color: #999999">{{ __('backend/Pages/addBrandForm.name') }}</span>
                            <input placeholder="{{ __('backend/Pages/addBrandForm.name_placeholder') }}" type="text" class="form-control" id="name" name="name" required>
                        </div>

                        <div class="mb-3">
                            <span style="font-style: italic; color: #999999">{{ __('backend/Pages/addBrandForm.url') }}</span>
