                                ...
                                <tr>
                                    <td>
                                        @if ($locale == 'es')
                                            ...
                                            <p>La reserva que realizó está pendiente de confirmación. Aquí están los detalles que proporcionó:</p>
                                        ...
                                        @elseif ($locale == 'en')
                                            <h1>Reservation Pending Confirmation</h1>
                                            <p>The reservation you made is pending confirmation. Here are the details you provided:</p>
                                            <p>Reservation made for: {{ $tourName }} </p>
                                            @if ($boat == 'small')
                                            ...
                                            @endif
                                            <p>Reservation Email: {{ $email }}</p>
                                            <p>Associated Phone: {{ $phone }}</p>
                                            <p>Reservation Date: {{ $day }} at {{ $time }}</p>
                                        @else
                                            <h1>Reserva Pendente de Confirmação</h1>
                                            <p>A reserva que efetuou está pendente de confirmação. Aqui estão os detalhes que forneceu:</p>
