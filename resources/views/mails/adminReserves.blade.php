                    ...
                    <tr>
                        <td style="box-sizing: border-box; padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        <h1>Reservation made by Admin</h1>
                                        <p>Your reservations was made by a Admin</p>
                                        <p>Reserve For: {{ $tour }} </p>
                                        @if ($boat == 'small')
                                            <p>Desired boat: Small</p>
                                        @elseif($boat == 'big')
                                            <p>Desired boat: Big</p>
                                        @else
                                            <p>Desired boat: Large</p>
                                        @endif
                                        <p>Reserve email: {{ $email }}</p>
                                        <p>Associated phone: {{ $phone }}</p>
                                        <p>Day and time for reserve: {{ $dia }} às {{ $hora }}</p>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
