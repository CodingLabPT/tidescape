                        ...
                        <td style="box-sizing: border-box; padding: 20px;">
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                ...
                                <tr>
                                    <td>
                                        @if ($locale == 'es')
                                            <h1>Registro exitoso en la newsletter</h1>
                                            <p>El correo electrónico <strong>{{ $email }}</strong> se ha registrado con éxito en nuestra newsletter. ¡Gracias!</strong></p>
                                        @elseif ($locale == 'en')
                                            <h1>Successful Newsletter Subscription</h1>
                                            <p>The email <strong>{{ $email }}</strong> has been successfully registered for our newsletter. Thank you!</strong></p>
                                        @else
                                            <h1>Assinatura da newsletter com sucesso</h1>
                                            <p>O email <strong>{{ $email }}</strong> foi registado com sucesso na nossa newsletter, Obrigado!! </strong></p>
                                        @endif
                                    </td>
                                </tr>
                                </tbody>
