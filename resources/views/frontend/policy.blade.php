...
<div class="breadcrumb-area section-bg-2 breadcrumb-padding" style="margin-top: 2.5%">
    ...
    <section class="contact-area pat-100 pab-100">
        <div class="container">
            <div class="contact-map">
                <iframe src="https://mapcarta.com/pt/N4378105291/Mapa"></iframe>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6 mt-5">
                    <div class="contact-wrapper contact-padding bg-white radius-20">
                        <div class="contact-contents">
                            <h4 class="contact-contents-title"> Entre em contacto </h4>
                            <p class="contact-contents-para mt-2"> Nossa simpática equipe adoraria ouvir de você. </p>
                            <div class="contact-contents-form custom-form">
                                <form action="#" method="POST">
                                    <div class="single-flex-input mt-4">
                                        <div class="single-input mt-4">
                                            <input type="text" class="form--control radius-5" id="fn" name="fn" placeholder="Primeiro Nome" required>
                                        </div>
                                        <div class="single-input mt-4">
                                            <input type="text" class="form--control radius-5" id="ln" name="ln" placeholder="Último Nome" required>
                                        </div>
                                    </div>
                                    <div class="single-input mt-4">
                                        <input type="email" class="form--control radius-5" id="email" name="email" placeholder="Email" required>
                                    </div>
                                    <div class="single-input mt-4">
                                        <input type="tel" class="form--control radius-5" id="phone" name="phone" placeholder="Numero" required>
                                    </div>
                                    <div class="single-input mt-4">
                                        <textarea class="form--control form-message radius-5" id="mensage" name="mensage" placeholder="Digite a sua mensagem" required></textarea>
                                    </div>
                                    <button id="btn" name="btn" type="text" class="btn btn-primary radius-5 padding-10"> Entrar em contacto </button>
                                </form>
                                                            </div>
                        </div>
                    </div>
