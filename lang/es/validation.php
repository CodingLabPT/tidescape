...
return [
    ...
    */
    ...
    | convenção "attribute.rule" para nomear as linhas. Isso nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
    ...
    | por algo mais fácil de ler, como "Endereço de E-mail" em vez de "email". Isso nos ajuda a tornar nossa mensagem mais expressiva.
    |
    */
